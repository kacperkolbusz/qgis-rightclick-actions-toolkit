        ...
        try:
            ...
            try:
                self.record_informational(
                    description=f"Toggled visibility for {layers_changed} layer(s): {action_description}",
                    meta={
                        'layers_processed': layers_changed,
                        'basemap_included': include_basemap_layers,
                        'visibility': action_description
                    }
                )
            except Exception:
                pass
