"""
Split Polygon Layer by Attribute Action for Right-click Utilities and Shortcuts Hub

Splits a polygon layer into multiple layers based on a selected attribute field.
...
class SplitPolygonLayerByAttributeAction(BaseAction):
    """Action to split a polygon layer into multiple layers based on an attribute field."""
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "split_polygon_layer_by_attribute"
        self.name = "Split Layer by Attribute"
        self.category = "Editing"
        self.description = "Split a polygon layer into multiple layers based on a selected attribute field. Each unique value creates a new layer containing all features with that value. All other attribute fields are preserved in the split layers."
        self.enabled = True
    ...
    def execute(self, context):
        """Execute the split polygon layer by attribute action."""
        try:
...
split_polygon_layer_by_attribute_action = SplitPolygonLayerByAttributeAction()
