    ...
    def execute(self, context):
        ...
        try:
            ...
            try:
                ...
                # Preserve original geometry for undo
                try:
                    original_geom = QgsGeometry(clicked_geometry)
                except Exception:
                    original_geom = None
                ...
                # After commit, record undo payload (old/new geometry)
                try:
                    ...
                    self.record_to_history(
                        description=f"Snapped point feature {feature.id()} to nearest line in layer {layer.name()}",
        ...
        for layer in line_layers:
            for feature in layer.getFeatures():
                ...
                if distance < closest_distance:
                    # Use nearestPoint() to get the exact perpendicular projection
