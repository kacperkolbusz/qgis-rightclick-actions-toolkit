...
class RotatePolygonAction(BaseAction):
    ...
    def execute(self, context):
        ...
        try:
            ...
            # After commit — record history entry for geometry update
            try:
                ...
                new_geom = None
                try:
                    new_wkb = rotated_geometry.asWkb()
                ...
                self.record_to_history(
                    description=f"Rotated feature {feature.id()} in layer {layer.name()} by {rotation_angle:.1f}°",
