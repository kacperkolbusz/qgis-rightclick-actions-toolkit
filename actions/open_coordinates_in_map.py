            ...
            try:
                ...
                try:
                    ...
                    self.record_to_history(
                        description=f"Opened {map_service} at ({lat:.6f}, {lon:.6f})",
                        undo_type=HistoryManager.UNDO_TYPE_INFORMATIONAL,
                        can_undo=False,
                        undo_payload=None,
                        layers=None,
                        features=None,
                        meta={'lat': lat, 'lon': lon, 'map_service': map_service, 'zoom': zoom_level}
                    )
                except Exception:
                    pass
