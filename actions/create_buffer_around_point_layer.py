"""
Create Buffer Around Point Layer

Creates buffers around all point features in the clicked layer and writes them to a new polygon layer.
"""
...
class CreateBufferAroundPointLayerAction(BaseAction):
    def __init__(self):
        super().__init__()
        self.action_id = "create_buffer_around_point_layer"
        self.name = "Create Buffer Around Point Layer"
        self.category = "Geometry"
        self.description = "Create buffers around all points in the clicked point layer."
        self.enabled = True
    ...
    def get_settings_schema(self):
        return {
            ...
            'layer_storage_type': {'type': 'choice', 'default': 'temporary', 'options': ['temporary', 'permanent']},
            'output_layer_name': {'type': 'str', 'default': 'Point Buffers'},
    ...
    def execute(self, context):
        try:
            ...
            out_name = str(self.get_setting('output_layer_name', 'Point Buffers'))
        ...
        # Record history with full layer definition for redo
...
# global instance
create_buffer_around_point_layer = CreateBufferAroundPointLayerAction()
