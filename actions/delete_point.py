...
class DeletePointAction(BaseAction):
    ...
    def execute(self, context):
        ...
        try:
            ...
            confirmation_template = str(self.get_setting('confirmation_message_template', 'Are you sure you want to delete feature ID {feature_id} from layer \'{layer_name}\'?'))
            auto_commit = bool(self.get_setting('auto_commit_changes', True))
            show_success = bool(self.get_setting('show_success_message', True))
            success_template = str(self.get_setting('success_message_template', 'Feature ID {feature_id} deleted successfully from layer \'{layer_name}\''))
