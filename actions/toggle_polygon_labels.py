"""
Toggle Polygon Layer Labels Action for Right-click Utilities and Shortcuts Hub

Toggles label visibility for polygon layers when a polygon feature is clicked.
"""
...
class TogglePolygonLabelsAction(BaseAction):
    """Action to toggle label visibility for polygon layers."""
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "toggle_polygon_labels"
        self.name = "Toggle Polygon Layer Labels"
        self.category = "Editing"
        self.description = "Toggle label visibility for the polygon layer of the selected polygon feature. Switches between showing and hiding layer labels."
        self.enabled = True
    ...
    def execute(self, context):
        """
        Execute the toggle polygon labels action.
        ...
        if not isinstance(layer, QgsVectorLayer) or layer.geometryType() != 2:  # 2 is polygon geometry type
            self.show_error("Error", "This action works only with polygon layers")
            return
            ...
            if not is_labels_enabled:
                ...
                if label_field:
                    ...
                    placement_map = {
                        ...
                        'buffer': QgsPalLayerSettings.OverPoint,
                        'offset': QgsPalLayerSettings.OverPoint
                    }
...
toggle_polygon_labels_action = TogglePolygonLabelsAction()
