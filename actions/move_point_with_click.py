    ...
    def _move_feature_to_geometry(self, feature, layer, new_geometry):
        ...
        try:
            ...
            if create_copy:
                ...
                # Use the added feature (has real FID)
                new_feature = added[0]
            ...
            try:
                ...
                # Prepare old/new geometry backups
                old_geom = None
                try:
                    if original_geom is not None and original_geom.isGeosValid():
                ...
                try:
                    ...
                    new_geom_b = {'wkb_base64': base64.b64encode(new_geom_wkb).decode('utf-8')}
                except Exception:
                    new_geom_b = None
