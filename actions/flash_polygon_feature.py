        ...
        try:
            ...
            try:
                self.record_informational(
                    description=f"Flashed polygon feature {feature.id()} on layer '{layer.name()}' for {flash_duration}s",
                    meta={
...
def _attach_non_undo_methods():
    ...
    FlashPolygonFeatureAction.supports_undo = supports_undo
    FlashPolygonFeatureAction.get_undo_category = get_undo_category

_attach_non_undo_methods()
