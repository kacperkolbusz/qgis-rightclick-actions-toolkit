...
class MoveLineAction(BaseAction):
    ...
    def _move_feature_to_geometry(self, feature, layer, new_geometry):
        ...
        try:
            ...
            # Old and new geometry backups
            old_geom = None
            new_geom = None
            try:
                old_wkb = original_geometry.asWkb()
            ...
            try:
                if create_copy:
                    # Backup new feature and record create_feature
                    try:
                    ...
                    self.record_to_history(
                        description=f"Moved feature {feature.id()} in layer {layer.name()}",
