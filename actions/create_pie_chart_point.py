"""
Create Pie Chart for Point Layer Action for Right-click Utilities and Shortcuts Hub

Creates a pie chart visualization of attribute values for point features.
...
class CreatePieChartPointAction(BaseAction):
    """Action to create pie charts for point features."""
    ...
    def __init__(self):
        ...
        # Required properties
        self.action_id = "create_pie_chart_point"
        self.name = "Create Pie Chart"
        self.category = "Analysis"
        self.description = "Create a pie chart visualization of attribute values for point features. Allows selection of any field to visualize, displaying value distribution as proportions. Works with text, numeric, and other field types. Supports exporting charts, visual presets, and customization options."
        self.enabled = True
    ...
    def supports_undo(self) -> bool:
        """This action is informational (creates a chart) and is NOT undoable."""
        return False

    def get_undo_category(self) -> str:
        """Return undo category for consistency with the guide: 'informational' (no undo)."""
    ...
    def execute(self, context):
        ...
        try:
            ...
            try:
                ...
                desc = f"Displayed pie chart for layer '{layer.name()}'"
                meta = {
                    'layer_id': layer.id(),
...
create_pie_chart_point_action = CreatePieChartPointAction()
