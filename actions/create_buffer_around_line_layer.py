"""
Create Buffer Around Line Layer

Creates buffers around all line features in the clicked layer and writes them to a new polygon layer.
"""
...
class CreateBufferAroundLineLayerAction(BaseAction):
    def __init__(self):
        super().__init__()
        self.action_id = "create_buffer_around_line_layer"
        self.name = "Create Buffer Around Line Layer"
        self.category = "Geometry"
        self.description = "Create buffers around all lines in the clicked line layer."
        self.enabled = True
    ...
    def get_settings_schema(self):
        return {
            ...
            'output_layer_name': {'type': 'str', 'default': 'Line Buffers'},
    ...
    def execute(self, context):
        try:
            ...
            out_name = str(self.get_setting('output_layer_name', 'Line Buffers'))
...
# global instance
create_buffer_around_line_layer = CreateBufferAroundLineLayerAction()
