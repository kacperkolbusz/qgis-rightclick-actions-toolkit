    ...
    def execute(self, context):
        ...
        try:
            ...
            if add_to_project:
                ...
                # Record history: creation of the areas layer so redo can restore styling and labels
                try:
                    ...
                    hm.record(
                        ...
                        description=f"Created area layer '{area_layer.name()}' with {len(feat_backups)} feature(s)",
