    ...
    def execute(self, context):
        ...
        try:
            ...
            if create_copy:
                ...
                # Keep a copy of the original geometry for undo recording
                try:
            ...
            # After commit — record history for undo/redo
            try:
                ...
                if create_copy:
                    ...
                    self.record_to_history(
                        description=f"Created smoothed copy of feature {feature.id()} in layer {layer.name()}",
                    ...
                    # Prepare old/new geometry payloads
                    old_geom = None
                    try:
                    ...
                    new_geom = None
                    try:
                        new_geom_wkb = smoothed_geometry.asWkb()
                    ...
                    self.record_to_history(
                        description=f"Smoothed polygon feature {feature.id()} in layer {layer.name()}",
                ...
                # History recording should not block success
                pass
