...
Creates a polygon buffer around the clicked line feature.
"""
...
class CreateBufferAroundLineAction(BaseAction):
    def __init__(self):
        super().__init__()
        self.action_id = "create_buffer_around_line"
        self.name = "Create Buffer Around Line"
        self.category = "Geometry"
        self.description = "Create a polygon buffer around the clicked line feature."
        self.enabled = True
        ...
        # Support line clicks
        self.set_supported_click_types(['line'])
    ...
    def get_settings_schema(self):
        return {
            ...
            'output_layer_name': {'type': 'str', 'default': 'Line Buffer'},
    ...
    def execute(self, context):
        try:
            ...
            out_name = str(self.get_setting('output_layer_name', 'Line Buffer'))
        ...
        if bool(self.get_setting('add_to_project', True)):
        ...
        self.record_to_history(
            description=f"Created buffer for line feature {feature.id()}",
...
# global instance
create_buffer_around_line = CreateBufferAroundLineAction()
